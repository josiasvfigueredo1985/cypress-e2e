...
- [git](https://git-scm.com/downloads) (I've used version `2.40.0` while writing this doc)
- [nodejs](https://nodejs.org/en/) (I've used version `16.19.1` while writing this doc)
- NPM (I've used version `9.6.2` while writing this doc)
...
Made with ❤️ by [Josias Valentim](https://github.com/josiasvfigueredo1985).
